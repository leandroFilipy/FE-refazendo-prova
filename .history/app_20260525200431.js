async function carregar6() {
    ...
    try{
        ...
        destacados.forEach(produto => {
            ...
            container.innerHTML += `
            <div class="card" onclick="window.location.href='detail.html?id=${destacados.id}'" style="cursor: pointer">
                    <img src=${destacados[i].imagem} alt="Nome do Produto" class="card-image" onerror="this.src='https://placehold.co/300x200?text=Sem+Imagem'">
                    <div class="card-body">
